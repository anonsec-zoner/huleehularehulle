...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text(tld(chat.id, f"{fname} is going to Enjoy real world. 😇"))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        ...
        update.effective_message.reply_text(tld(chat.id, f"{firstname} is back to virtual world!😀"))
